...
const Table2 = ({ data }) => {
  ...
  const calculateStatistics = (data) => {
    ...
    const gpas = Object.values(studentGPAs).map((student) => {
      return student.totalCredits > 0
        ? student.totalGradePoints / student.totalCredits
        : 0;
    });
    ...
    const stats = {
      ...
      passed: Object.values(passedStudents).filter(
            ...
            <Table className="text-sm border-collapse border border-gray-200 w-full">
              ...
              <TableBody>
                <TableRow className="bg-white">
                  <TableCell className="font-medium py-3 px-4 break-all">
                ...
                <TableRow className="bg-white">
                  <TableCell className="font-medium py-3 px-4 break-all">
                    No. of Candidates scored more than 9.0 GPA
                  </TableCell>
                  <TableCell className="py-3 px-4">
                ...
                <TableRow className="bg-gray-50">
                  <TableCell className="font-medium py-3 px-4 break-all">
                    No. of Candidates scored more than 8.5 GPA
                  </TableCell>
                  <TableCell className="py-3 px-4">
                ...
                <TableRow className="bg-white">
                  <TableCell className="font-medium py-3 px-4 break-all">
                    No. of Candidates scored more than 8.0 GPA
                  </TableCell>
                  <TableCell className="py-3 px-4">
                ...
                <TableRow className="bg-gray-50">
                  <TableCell className="font-medium py-3 px-4 break-all">
                    No. of Candidates scored more than 7.5 GPA
                  </TableCell>
                  <TableCell className="py-3 px-4">
                ...
                <TableRow className="bg-white">
                  <TableCell className="font-medium py-3 px-4 break-all">
                    No. of Candidates scored more than 7.0 GPA
                  </TableCell>
                  <TableCell className="py-3 px-4">
                ...
                <TableRow className="bg-gray-50">
                  <TableCell className="font-medium py-3 px-4 break-all">
                    No. of Candidates scored more than 6.5 GPA
                  </TableCell>
                  <TableCell className="py-3 px-4">
                ...
                <TableRow className="bg-white">
                  <TableCell className="font-medium py-3 px-4 break-all">
                    No. of Candidates scored more than 6.0 GPA
                  </TableCell>
                  <TableCell className="py-3 px-4">
                ...
                <TableRow className="bg-gray-50">
                  <TableCell className="font-medium py-3 px-4 break-all">
                    No. of Candidates scored more than 5.5 GPA
                  </TableCell>
                  <TableCell className="py-3 px-4">
                ...
                <TableRow className="bg-white">
                  <TableCell className="font-medium py-3 px-4 break-all">
                    No. of Candidates scored more than 5.0 GPA
                  </TableCell>
                  <TableCell className="py-3 px-4">
